...
$scope.images_work = [
          { num: 1,  category: 'web', name: 'theRRD', src: "portfolio/theRRD-Webapp.png", description: 'This project was built using NodeJS, AngularJS, jQuery, Javascript, HTML, CSS, and Bootstrap. theRRD offers a wide range of tools for Landlords, Property Managers, and Real Estate Agents. One Site. One Login. One Site. One Login. Multiple Efficiencies.' },
          { num: 2,  category: 'market', name: 'theRRD Branding', src: "portfolio/theRRD-Branding.jpg", description: 'Very Simple yet Unique Stationary design pack for your personal use or any kind of business. Package includes: Business Card Design, Letter Head Design and Envelope Design. Creating a consistent ecosystem for your brand or personal objective.' },
          { num: 3,  category: 'web', name: 'E-Commerce', src: "portfolio/e-comm.png", description: 'E-Commerce Solution, Let Your Buyers Buy. E-Commerce Solution that can present you information in a whole. Showcase your products and be able to have dynamic performance with your buyers. One click to cart method allows the user to quickly check out. ' },
          { num: 4,  category: 'web', name: 'Content Filter', src: "portfolio/content-filter.png", description: 'Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat. ' },
          { num: 5,  category: 'creative', name: 'Flippy Cards', src: "portfolio/flippy-cards.png", description: 'Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat. ' },
          { num: 6,  category: 'market', name: 'theRRD Pop-Banner', src: "1.jpg", description: 'Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat. '},
          { num: 7,  category: 'market', name: 'theRRD Tri-Fold', src: "portfolio/trifold.png", description: 'Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat. '},
          { num: 8,  category: 'market', name: 'theRRD Table Banner', src: "portfolio/table-banner.png", description: 'Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat. '},
          { num: 9,  category: 'web', name: 'Angular Weather Application', src: "2.jpg", description: 'Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat.'}];
...
app.controller('formCtrl', function($scope) {
    ...
    $scope.computedTotal = function () {
        var opts = $scope.opts;
        var total = (opts.val1 ? 100 : 0) + (opts.val2 ? 250 : 0) + (opts.val3 ? 100 : 0) + (opts.val4 ? 250 : 0) + (opts.val5 ? 100 : 0) + (opts.val6 ? 250 : 0);
        return total;
    };
});
